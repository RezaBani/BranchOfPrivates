...
public:
    explicit LetterDialog(const QString &tab, const QString &code, const QMap<QString,QStringList> &combosMap, QWidget *parent = nullptr);
    ~LetterDialog();
...
private slots:
    ...
    void sendChangeInOrder(const QString &sheetName, const QStringList &values, const int &newValues);
    void sendRemoveOrder(const QString &sheetName, const QStringList &values);
